...
#http://code.activestate.com/recipes/579118-pyqt-touch-input/
#author http://code.activestate.com/recipes/users/4193036/
...
class MyFlatPushButton(QtGui.QPushButton):
    def __init__(self, caption, min_size=(40, 40)):
